...
local module_install_order = {"bufferline", "diffview", "markview", "mason", "minimap", "nvim-lspconfig", "mason-lspconfig", "nord", "nvim-cmp", "nvim-dap", "mason-nvim-dap", "nvim-dap-ui", "nvim-tree", "telescope", "toggleterm"}
...
local module_config_order = {"bufferline", "diffview", "markview", "mason", "minimap", "mason-lspconfig", "nvim-lspconfig", "mason-nvim-dap", "nord", "nvim-cmp", "nvim-dap-ui", "nvim-dap", "nvim-tree", "telescope", "toggleterm"}
